...
export async function exportPresentation() {
  ...
  // ===== SLIDE 6: Tech Stack =====
  {
    ...
    slide.background = { color: BG };
    addCornerAccents(slide);
    slide.addText("🖥️  TECHNOLOGY", { x: 0.8, y: 0.5, w: 6, h: 0.5, fontSize: 13, fontFace: "Calibri", bold: true, color: PRIMARY });
  ...
  // ===== SLIDE 7: Impact =====
  {
    ...
    slide.background = { color: BG };
    addCornerAccents(slide);
    slide.addText("📈  BUSINESS IMPACT", { x: 0.8, y: 0.5, w: 6, h: 0.5, fontSize: 13, fontFace: "Calibri", bold: true, color: ACCENT });
